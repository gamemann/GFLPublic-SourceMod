...
stock ForwardConVars() 
{
	...
	g_hLogging = CreateConVar("GFLCore_Logging", "1", "Enable logging for GFL's plugins?");
	HookConVarChange(g_hLogging, CVarChanged);
	
	g_hLoggingPath = CreateConVar("GFLCore_LoggingPath", "logs/GFL/", "The path starting from SourceMod/ that the logs will be entered in.");
